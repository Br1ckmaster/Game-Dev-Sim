...
public class EnemyOne: MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (Vector3.Distance(playerOne.position, this.transform.position) < 5 /*&& angle < 30*/)
        {
            directionOne.y = 0;
        ...
        else if (Vector3.Distance(playerTwo.position, this.transform.position) < 5 /*&& angle < 30*/)
        {
            directionTwo.y = 0;
